...
def dis(verbose=False):
    dir_path = 'data/conll2014/conll14st-test-data/noalt/'
    ...
    if verbose:
        ...
        print('Num of error types:', len(sorted_errors_sum_dict))
        print('Fine-grained dic:', fine_grained_dict)
    ...
    if verbose:
        print("Coarse dis:", coarse_dis)
        print("Fine dis:", fine_dis)

    return coarse_dis, fine_dis, false_sets

def stat():
    dir_path = '/home/quanyu/GEC/helo-word/data/conll2014/conll14st-test-data/noalt/'
    dir_path = 'data/conll2014/conll14st-test-data/noalt/'
    file_path = os.path.join(dir_path, 'official-2014.combined.m2')
...
def main():
    ...
    coarse_dis, fine_dis, false_sets = dis()
